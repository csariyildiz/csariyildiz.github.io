...
Ağacı daha çok "split" (bölünme) içerecek şekilde daha derin hale getirebiliriz.  Örneğin dairen kaç metrekare olduğuna aşağıdaki gibi karar verilebilir.
...
Split ve leaf'lerdeki değerler data tarafından belirlenecektir. Bu nedenle data üzerinde yapılacak kontroller önemlidir.
