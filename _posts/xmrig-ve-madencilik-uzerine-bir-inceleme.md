...
1. *Kripto Para Birimleri ve Mining Ne İfade Ediyor?* Bu bölümde genel olarak miming'in zaman içerisinde nasıl geliştiğini özetleyeceğiz.
...
## 1. Kripto Para Birimleri ve Mining Ne İfade Ediyor?

Kripto para yatırımlarının itibarının, özellikle 11 Kasım 2022'deki `FTX` iflası sonrasında bir miktar sarsılsa da kripto paralar ve blok zinciri teknolojisinin varlığı bu olaylardan etkilenmiyor.
Kripto paraların popülerlik kazanmaya başladığı 2010'lu yılların ortalarından itibaren hayatımızda çok şey değişti.
İnsanlar bu yeni gelişmelere farklı tepkiler verdi vermeye de devam ediyorlar. Kimi için kelime olumlu şeyler çağrıştırıyor, kimi direkt adapte olmuş ya da denemiş durumda. Kimi ise daha temkinli bir yaklaşım sergiliyor.
...
* [Getmonero](https://www.getmonero.org/downloads/) adresinden WebGUI'yi indirip adımları takip ederek cüzdanı oluşturalım.
...
* Cihazlar ne kadar sürede kendi ödemelerini çıkarabilir? ROI değerleri nedir?
* Optimizasyon nasıl yapılabilir?
* Task managerda CPU %43.5 olarak görüyorum. Bu oran aslında bilgisayarı kullanırken iyi fakat kullanmadığımızı gösteriyor. Nasıl arttırılabilir?
* Algo switching opsiyonu çalışıyor mu?
* XMRig kodu nasıl yapılandırılmış? Hangi geliştirme kütüphaneleri kullanılmış olabilir?

## Referanslar

* CPU gücünün direkt olarar paraya dönüştürebilmesi ekonomik olarak ne anlam ifade eder? CPU kuvveti çalınabilir vb.
